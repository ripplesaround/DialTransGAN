...
# from instructor.oracle_data.cot_trans_instructor import CoTTransInstructor
...
if __name__ == '__main__':
    ...
    if cfg.if_real_data:
        ...
        from instructor.real_data.cot_trans_instructor import CoTTransInstructor
