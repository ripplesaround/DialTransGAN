...
from models.CoT_D_trans import Cot_D_trans
from models.CoT_G_trans import CoT_G_trans
from utils.data_loader import GenDataIter


class CoTTransInstructor(BasicInstructor):
    def __init__(self, opt):
        super(CoTTransInstructor, self).__init__(opt)

        # generator, discriminator
        self.gen = CoT_G_trans(cfg.gen_embed_dim,  cfg.vocab_size, cfg.max_seq_len,
                         cfg.padding_idx, gpu=cfg.CUDA)
        self.dis = Cot_D_trans(cfg.gen_embed_dim * 2,  cfg.vocab_size, cfg.max_seq_len,
